...
### Function ###
QDR2018C <- function(sex = NULL, age = NULL,
                     bmi = NULL, ht = NULL, wt = NULL, hba1c = NULL,
  ...
  ## Stop Conditions ##
  if(any(is.null(sex), is.null(age), is.null(hba1c))) stop("sex, age & hba1c must be specified")
