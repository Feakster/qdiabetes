...
<<>>=
QDR2018A(gender = "Female", age = 65, height = 1.65, weight = 70)
QDR2018A(gender = "Male", age = 54, bmi = 35)
@
...
<<>>=
dat_qdr[["risk"]] <- with(dat_qdr, QDR2018A(gender = gender, age = age, bmi = bmi))
@
...
dt_qdr[, risk := QDR2018A(gender = gender, age = age, bmi = bmi)]
...
df_qdr <- df_qdr %>%
  mutate(risk = QDR2018A(gender = gender, age = age, bmi = bmi))
df_qdr %>%
...
<<>>=
# "A" Variant
dat_qdr[["qdr2018a"]] <- with(dat_qdr, QDR2018A(gender = gender,
                                                age = age,
                                                bmi = bmi))
# "B" Variant
dat_qdr[["qdr2018b"]] <- with(dat_qdr, QDR2018B(gender = gender,
                                                age = age,
                                                bmi = bmi,
                                                fpg = fpg))
# "C" Variant
dat_qdr[["qdr2018c"]] <- with(dat_qdr, QDR2018C(gender = gender,
                                                age = age,
                                                bmi = bmi,
                                                hba1c = hba1c))

# Output
head(dat_qdr[, c("gender", "age", "bmi", "fpg", "hba1c", "qdr2018a", "qdr2018b", "qdr2018c")])
@
...
## Estimate Risk
suppressWarnings({
  df[["risk"]] <- with(df,  QDR2018A(gender = "Male",
                                     age = 65,
                                     height = height,
                                     weight = weight))
})
...
## Estimate Risk
df[["risk"]] <- with(df,  QDR2018B(gender = "Male",
                                   age = age,
                                   bmi = 30,
                                   fpg = fpg))
...
## Estimate Risk
df[["risk"]] <- with(df,  QDR2018C(gender = "Male",
                                   age = age,
                                   bmi = 30,
                                   hba1c = hba1c))
