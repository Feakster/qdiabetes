...
<<>>=
dat_qdr[["risk"]] <- with(dat_qdr, QDRA(gender = gender, age = age, bmi = bmi))
@
...
dt_qdr[, risk := QDRA(gender = gender, age = age, bmi = bmi)]
...
df_qdr <- df_qdr %>%
  mutate(risk = QDRA(gender = gender, age = age, bmi = bmi))
df_qdr %>%
...
<<>>=
# "A" Variant
dat_qdr[["qdra"]] <- with(dat_qdr, QDRA(gender = gender,
                                        age = age,
                                        bmi = bmi))
# "B" Variant
dat_qdr[["qdrb"]] <- with(dat_qdr, QDRB(gender = gender,
                                        age = age,
                                        bmi = bmi,
                                        fpg = fpg))
# "C" Variant
dat_qdr[["qdrc"]] <- with(dat_qdr, QDRC(gender = gender,
                                        age = age,
                                        bmi = bmi,
                                        hba1c = hba1c))
...
## Estimate Risk
suppressWarnings({
  df[["risk"]] <- with(df,  QDRA(gender = "Male",
                                 age = 65,
                                 height = height,
                                 weight = weight))
})
...
## Estimate Risk
df[["risk"]] <- with(df,  QDRB(gender = "Male",
                               age = age,
                               bmi = 30,
                               fpg = fpg))
...
## Estimate Risk
df[["risk"]] <- with(df,  QDRC(gender = "Male",
                               age = age,
                               bmi = 30,
                               hba1c = hba1c))
