...
### Correct Range ###
dat_test[["risk_min"]] <- with(dat_test, QDRC(gender = "Female",
                                               age = age,
                                               bmi = bmi,
                                               hba1c = hba1c,
                                               townsend = -7.028634577))

dat_test[["risk_max"]] <- with(dat_test, QDRC(gender = "Female",
                                               age = age,
                                               bmi = bmi,
                                               hba1c = hba1c,
...
### Correct Range ###
dat_test[["risk_min"]] <- with(dat_test, QDRC(gender = "Male",
                                               age = age,
                                               bmi = bmi,
                                               hba1c = hba1c,
                                               ethnicity = "WhiteNA",
                                               smoking = "Non",
                                               townsend = -7.028634577))
dat_test[["risk_max"]] <- with(dat_test, QDRC(gender = "Male",
                                               age = age,
                                               bmi = bmi,
                                               hba1c = hba1c,
                                               ethnicity = "Bangladeshi",
