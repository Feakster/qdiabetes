...
# ### Binary Variables ###
# tQDRC <- function(...){gQDRC(age = 60, height = 1.83, weight = 90, hba1c = 31.5, ...)}
# expect_equal(tQDRC(antipsy = T), , tolerance = tol, label = "QDRC-Female [antipsy = T]")
# expect_equal(tQDRC(steroids = T), , tolerance = tol, label = "QDRC-Female [steroids = T]")
# expect_equal(tQDRC(cvd = T), , tolerance = tol, label = "QDRC-Female [cvd = T]")
# expect_equal(tQDRC(gestdiab = T), , tolerance = tol, label = "QDRC-Female [gestdiab = T]")
# expect_equal(tQDRC(learndiff = T), , tolerance = tol, label = "QDRC-Female [learndiff = T]")
# expect_equal(tQDRC(schizobipo = T), , tolerance = tol, label = "QDRC-Female [schizobipo = T]")
# expect_equal(tQDRC(pcos = T), , tolerance = tol, label = "QDRC-Female [pcos = T]")
# expect_equal(tQDRC(statins = T), , tolerance = tol, label = "QDRC-Female [statins = T]")
# expect_equal(tQDRC(hypertension = T), , tolerance = tol, label = "QDRC-Female [hypertension = T]")
# expect_equal(tQDRC(fh_diab = T), , tolerance = tol, label = "QDRC-Female [fh_diab = T]")
# rm(tQDRC)
...
# ### Binary Variables ###
# tQDRC <- function(...){gQDRC(age = 60, height = 1.83, weight = 90, hba1c = 31.5, ...)}
# expect_equal(tQDRC(antipsy = T), , tolerance = tol, label = "QDRC-Male [antipsy = T]")
# expect_equal(tQDRC(steroids = T), , tolerance = tol, label = "QDRC-Male [steroids = T]")
# expect_equal(tQDRC(cvd = T), , tolerance = tol, label = "QDRC-Male [cvd = T]")
# expect_equal(tQDRC(learndiff = T), , tolerance = tol, label = "QDRC-Male [learndiff = T]")
# expect_equal(tQDRC(schizobipo = T), , tolerance = tol, label = "QDRC-Male [schizobipo = T]")
# expect_equal(tQDRC(statins = T), , tolerance = tol, label = "QDRC-Male [statins = T]")
# expect_equal(tQDRC(hypertension = T), , tolerance = tol, label = "QDRC-Male [hypertension = T]")
# expect_equal(tQDRC(fh_diab = T), , tolerance = tol, label = "QDRC-Male [fh_diab = T]")
# rm(tQDRC)
