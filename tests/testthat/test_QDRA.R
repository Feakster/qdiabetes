...
### Correct Range ###
dat_test[["risk_min"]] <- with(dat_test, QDRA(gender = "Female",
                                               age = age,
                                               bmi = bmi,
                                               townsend = -7.028634577))

dat_test[["risk_max"]] <- with(dat_test, QDRA(gender = "Female",
                                               age = age,
                                               bmi = bmi,
...
### Correct Range ###
dat_test[["risk_min"]] <- with(dat_test, QDRA(gender = "Male",
                                               age = age,
                                               bmi = bmi,
                                               ethnicity = "WhiteNA",
                                               smoking = "Non",
                                               townsend = -7.028634577))
dat_test[["risk_max"]] <- with(dat_test, QDRA(gender = "Male",
                                               age = age,
                                               bmi = bmi,
                                               ethnicity = "Bangladeshi",
                                               smoking = "Heavy",
