...
### Correct Range ###
dat_test[["risk_min"]] <- with(dat_test, QDRB(gender = "Female",
                                               age = age,
                                               bmi = bmi,
                                               fpg = fpg,
                                               townsend = -7.028634577))

dat_test[["risk_max"]] <- with(dat_test, QDRB(gender = "Female",
                                               age = age,
                                               bmi = bmi,
                                               fpg = fpg,
...
### Correct Range ###
dat_test[["risk_min"]] <- with(dat_test, QDRB(gender = "Male",
                                               age = age,
                                               bmi = bmi,
                                               fpg = fpg,
                                               ethnicity = "WhiteNA",
                                               smoking = "Non",
                                               townsend = -7.028634577))
dat_test[["risk_max"]] <- with(dat_test, QDRB(gender = "Male",
                                               age = age,
                                               bmi = bmi,
                                               fpg = fpg,
                                               ethnicity = "Bangladeshi",
