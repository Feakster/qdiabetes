...
expect_error(tQDRB(height = 1.83), label = "QDRB-Female [is.null(weight) & is.null(bmi)]")
expect_error(tQDRB(weight = 90), label = "QDRB-Female [is.null(height) & is.null(bmi)]")
expect_warning(tQDRB(bmi = 30, height = 1.83, weight = 90), label = "QDRB-Female [!is.null(height) & !is.null(weight) & !is.null(bmi)]")
rm(tQDRB)
## FPG ##
...
### Variable Combinations ###
## Gender ##
expect_error(rQDRB(age = 60, fpg = 4.5), label = "QDRB-Male []")
## Age ##
expect_error(gQDRB(fpg = 4.5), label = "QDRB-Male []")
## BMI, Height & Weight ##
tQDRB <- function(...){gQDRB(age = 60, fpg = 4.5, ...)}
expect_error(tQDRB(height = 1.83), label = "QDRB-Male []")
expect_error(tQDRB(weight = 90), label = "QDRB-Male []")
expect_warning(tQDRB(bmi = 30, height = 1.83, weight = 90), label = "QDRB-Male []")
rm(tQDRB)
## FPG ##
tQDRB <- function(...){gQDRB(age = 60, height = 1.83, weight = 90, ...)}
...
## HbA1c ##
tQDRB <- function(...){gQDRB(age = 60, height = 1.83, weight = 90, fpg = 4.5, ...)}
expect_error(tQDRB(hba1c = 31.5), label = "QDRB-Male []")
rm(tQDRB)

### Boundaries ###
## Age ##
tQDRB <- function(...){gQDRB(bmi = 30, fpg = 4.5, ...)}
expect_error(tQDRB(age = 24), label = "QDRB-Male []")
expect_error(tQDRB(age = 85), label = "QDRB-Male []")
rm(tQDRB)

## BMI ##
tQDRB <- function(...){gQDRB(age = 60, fpg = 4.5, ...)}
expect_error(tQDRB(bmi = (40/2.1^2) - 1), label = "QDRB-Male []")
expect_error(tQDRB(bmi = (180/1.4^2) + 1), label = "QDRB-Male []")
expect_warning(tQDRB(bmi = 19), label = "QDRB-Male []")
expect_warning(tQDRB(bmi = 41), label = "QDRB-Male []")
rm(tQDRB)

## Height ##
tQDRB <- function(...){gQDRB(age = 60, weight = 90, fpg = 4.5, ...)}
expect_error(tQDRB(height = 1.3), label = "QDRB-Male []")
expect_error(tQDRB(height = 2.2), label = "QDRB-Male []")
rm(tQDRB)

## Weight ##
tQDRB <- function(...){gQDRB(age = 60, height = 1.83, fpg = 4.5, ...)}
expect_error(tQDRB(weight = 39), label = "QDRB-Male []")
expect_error(tQDRB(weight = 181), label = "QDRB-Male []")
rm(tQDRB)

## FPG ##
tQDRB <- function(...){gQDRB(age = 60, height = 1.83, weight = 90, ...)}
expect_error(tQDRB(fpg = 1.9), label = "QDRB-Male []")
expect_error(tQDRB(fpg = 7), label = "QDRB-Male []")
rm(tQDRB)

## Townsend ##
tQDRB <- function(...){gQDRB(age = 60, height = 1.83, weight = 90, fpg = 4.5, ...)}
expect_error(tQDRB(townsend = -7.028634578), label = "QDRB-Male []")
expect_error(tQDRB(townsend = 13.3114712), label = "QDRB-Male []")
rm(tQDRB)
